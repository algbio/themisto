...
TEST(TEST_PSEUDOALIGN, random_testcases){
    ...
    for(TestCase tcase : generate_testcases(ref_length, n_refs, n_queries, query_length, k_min,k_max, n_colors)){
        ...
        string genomes_outfilename = temp_file_manager.get_temp_file_name("genomes-");
        string colors_outfilename = temp_file_manager.get_temp_file_name("colors-");
        string queries_outfilename = temp_file_manager.get_temp_file_name("queries-");
        string colorfile_outfilename = temp_file_manager.get_temp_file_name("colorfile-");
        string boss_outfilename = temp_file_manager.get_temp_file_name("boss-");
        string coloring_outfilename = temp_file_manager.get_temp_file_name("coloring-");
